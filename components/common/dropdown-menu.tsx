...
const DropdownMenuContent = ({
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cx(
        "z-50 min-w-40 flex flex-col overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-sm backdrop-blur-xs",
...
const DropdownMenuSubContent = ({
  ...
  <DropdownMenuPrimitive.SubContent
    className={cx(
      "z-50 min-w-40 overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-sm backdrop-blur-xs",
      popoverAnimationClasses,
      className,
    )}
    {...props}
