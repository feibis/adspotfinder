  ...
  return (
    <div
      className={cx(
        ...
        "prose-headings:scroll-mt-(--header-outer-offset) prose-headings:text-foreground prose-headings:font-semibold prose-headings:tracking-tight prose-strong:font-semibold",
